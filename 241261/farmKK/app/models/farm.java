...
public class farm extends Model {
    ...
    private String fram_name,farm_address,farm_tel,picture,date_farm;
    ...
    public farm(String farm_id, String fram_name, String farm_address, String farm_details, String farm_tel, String picture,String date_farm) {
      if(farm_id==null){
          setFarm_id();
      }else{
          setnewid(farm_id);
...
public void setnewid(String id){
    ...
    public String getDate_farm() {
        return date_farm;
    }

    public void setDate_farm(String date_farm) {
        this.date_farm = date_farm;
    }
