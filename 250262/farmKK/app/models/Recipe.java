...
public class Recipe extends Model {
    ...
    private int am1=0,am2=0,am3=0, am4=0,total;
    ...
    private List<Inputfood> inputfoodsList = new ArrayList<Inputfood>();
...
//setRid();
    ...
    public Recipe(String rid, Date dateRecipe, String dateTimeRecipe,int total, int amountCow, int am1, int am2, int am3,int am4, Foods foods) {
    this.rid=rid;
...
//    }
    ...
    public int getTotal() {
        return total=am1+am2+am3+am4;//getInputfood().getTotalPrice();
    }
    ...
    public void setInputfoodsList(List<Inputfood> inputfoodsList) {
        this.inputfoodsList = inputfoodsList;
    }
