...
alter table tbRecipe add constraint fk_tbRecipe_inputfood1_6 foreign key (inputfood1_id_ifoods) references tbInputfood (id_ifoods) on delete restrict on update restrict;
create index ix_tbRecipe_inputfood1_6 on tbRecipe (inputfood1_id_ifoods);
alter table tbRecipe add constraint fk_tbRecipe_inputfood2_7 foreign key (inputfood2_id_ifoods) references tbInputfood (id_ifoods) on delete restrict on update restrict;
create index ix_tbRecipe_inputfood2_7 on tbRecipe (inputfood2_id_ifoods);
alter table tbRecipe add constraint fk_tbRecipe_inputfood3_8 foreign key (inputfood3_id_ifoods) references tbInputfood (id_ifoods) on delete restrict on update restrict;
create index ix_tbRecipe_inputfood3_8 on tbRecipe (inputfood3_id_ifoods);
