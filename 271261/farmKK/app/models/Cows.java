...
public class Cows extends Model {
    ...
    public Cows(breeds breed,String status,String price,String cow_id, String sex, String color, Date date, String age, String picture, String weight, String height) {
        this.breed = breed;
        this.status=status;
        this.cow_id = cow_id;
        this.sex = sex;
